...
#ifndef THZ_MAC_MACRO_AP_HELPER_H
#define THZ_MAC_MACRO_AP_HELPER_H
 ...
 */
class THzMacMacroApHelper : public THzMacHelper
{
public:
  /**
   * Create a THzMacMacroApHelper that is used to enable the THz MAC layer
  ...
  /**
   * \internal
   * Destroy a THzMacMacroApHelper
   */
  virtual ~THzMacMacroApHelper ();

  /**
   * Create a THz MAC helper for macro-scale scenario in a default working state.
   */
  static THzMacMacroApHelper Default (void);
...
#endif /* THZ_MAC_MACRO_AP_HELPER_H */

...
THzUdpTraceClientHelper::THzUdpTraceClientHelper(Address address,
                                                 uint16_t port,
                                                 std::string filename)
{
...
THzUdpTraceClientHelper::THzUdpTraceClientHelper(Ipv4Address address,
                                                 uint16_t port,
                                                 std::string filename)
{
    m_factory.SetTypeId(THzUdpTraceClient::GetTypeId());
...
THzUdpTraceClientHelper::THzUdpTraceClientHelper(Ipv6Address address,
                                                 uint16_t port,
                                                 std::string filename)
{
    m_factory.SetTypeId(THzUdpTraceClient::GetTypeId());

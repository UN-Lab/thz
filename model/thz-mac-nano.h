...
class THzMacNano : public THzMac
{
  ...
  private:
     ...
     *
     * \param success value that indicates if the corresponding ACK packet has been successfully
     * received. \param sequence the sequence number of the packet whose.
     *
     ...
     *
     * Retransmission is caused by the CTS time out. If number of retransmissions surpass the
     * maximum retransmission limit, the transmission of the corresponding DATA packet is considered
     * as failed. No more retransmissions of this DATA packet is needed.
     */

 ...
 */
struct THzUdpTraceClient::TraceEntry THzUdpTraceClient::g_defaultEntries[] = {
  {
    0, 534, 'I'
  },
  {
...
{
  static TypeId tid = TypeId ("ns3::THzUdpTraceClient")
...
THzUdpTraceClient::THzUdpTraceClient (Ipv4Address ip, uint16_t port,
                                      char *traceFile)
{
  NS_LOG_FUNCTION (this);
  m_sent = 0;
...
uint16_t THzUdpTraceClient::GetMaxPacketSize (void)
{
  NS_LOG_FUNCTION (this);

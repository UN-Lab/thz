 ...
 *
 * This class implements the directional antenna with turning ability based on the cosine model as
 * described in: Li Chunjian, "Efficient Antenna Patterns for Three-Sector WCDMA Systems"
 *
...
class THzDirectionalAntenna : public Object
{
  public:
     ...
     * Note that the setting of antenna mode between 1 and 2 is depend on a specific
     * receiver-initiated handshake protocol, the setting of mode 2 is for the terahertz nano-scale
     * scenario. The detail MAC protocol is described in: Q.Xia, Z.Hossain, M.Medley and J.M Jornet,

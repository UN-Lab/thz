...
#ifndef THZ_UDP_TRACE_CLIENT_H
#define THZ_UDP_TRACE_CLIENT_H
 ...
 */
class THzUdpTraceClient : public Application
{
  public:
    /**
     ...
     *
     */
    THzUdpTraceClient(Ipv4Address ip, uint16_t port, char* traceFile);
    ~THzUdpTraceClient();
